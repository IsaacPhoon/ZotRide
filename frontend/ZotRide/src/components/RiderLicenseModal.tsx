...
interface RiderLicenseModalProps {
  riderId: number;
  onClose: () => void;
}

const RiderLicenseModal = ({ riderId, onClose }: RiderLicenseModalProps) => {
            ...
            <div className="card-body p-8">
              <div className="relative mb-6">
                <h1 className="text-3xl md:text-4xl font-bold text-black">
                  ...
                  <em className="font-normal">ZotRider</em>
                </h1>
...
export default RiderLicenseModal;
