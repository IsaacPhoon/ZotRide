...
const OrganizationFunctions = () => {
  const [requestCommentLength, setRequestCommentLength] = useState(0);
  ...
  return (
    <div className="bg-white text-black py-[4rem] px-[2rem] lg:px-[2rem]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-[8rem] items-start">
        {/* Request a ZotRide Form - Left Side */}
        <div className="space-y-[2rem]">
          <h1 className="text-5xl font-bold mb-12 text-center">
            Request a Club ZotRide
          </h1>
          ...
          <div className="relative pb-4">
            <textarea
              ...
              rows={5}
              maxLength={500}
              onChange={(e) => setRequestCommentLength(e.target.value.length)}
        ...
        {/* Host a ZotRide Form - Right Side */}
